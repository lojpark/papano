...
public class MainActivity extends AppCompatActivity
    ...
    public native int stringFromJNI(long matAddrInput, long matAddrResult);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        entered_key = stringFromJNI(matInput.getNativeObjAddr(), matResult.getNativeObjAddr());

        if(count >= 20 && entered_key == 1) {
            try {
